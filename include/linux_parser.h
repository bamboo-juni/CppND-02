...
const std::string filterProcMem("VmData:"); // The string can be VmSize(virtual memory) As well
...
long Jiffies(std::vector<long> j_set);
long ActiveJiffies(std::vector<long> j_set);
long ActiveJiffies(int pid);
long IdleJiffies(std::vector<long> j_set);
